...
void setup_CATM1()
{
    ...
    */
    ...
    /*
    We wait for the SIM7080G to register to the local 4G antenna / Check la valeur du cereg
    ...
    */
    ...
    // Vérifier Ip existante
    handle_ip();
    //Serial.println(send_AT("AT+CNACT?"));
